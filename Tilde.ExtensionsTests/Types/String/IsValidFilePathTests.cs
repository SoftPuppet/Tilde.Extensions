...
public class IsValidFilePathTests
{
    ...
    {
        string reason;
        bool result = StringExtensions.IsValidFilePath(@"C:\validpath\file.txt", out reason);
    ...
    {
        string reason;
        bool result = StringExtensions.IsValidFilePath(null!, out reason);
    ...
    {
        string reason;
        bool result = StringExtensions.IsValidFilePath(string.Empty, out reason);
        Assert.IsFalse(result);
        Assert.AreEqual("The provided string is empty.", reason);
    }
    ...
    {
        string reason;
        bool result = StringExtensions.IsValidFilePath("    ", out reason);
        Assert.IsFalse(result);
        Assert.AreEqual("The provided string is empty.", reason);
    }
    ...
    {
        string reason;
        bool result = StringExtensions.IsValidFilePath(@"C:\path\file<.txt", out reason); // '<' is usually an invalid character in file names
        Assert.IsFalse(result);
