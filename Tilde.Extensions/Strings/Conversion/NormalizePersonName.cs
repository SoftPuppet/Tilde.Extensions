...
public static partial class StringExtensions {
  private static readonly Regex _titlesAndSuffixesRegex = new Regex(@"\b(dr|jr|sr|iii|ii|iv|dame)\b", RegexOptions.IgnoreCase);
  ...
  private static string RemoveTitlesAndSuffixes(string text) {
    return _titlesAndSuffixesRegex.Replace(text, "");
  }
}
